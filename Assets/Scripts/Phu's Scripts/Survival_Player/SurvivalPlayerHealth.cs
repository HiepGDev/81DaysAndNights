...
public class SurvivalPlayerHealth : MonoBehaviour
{
    ...
    private SurvivalPlayerMovement SurvivalplayerMovement;
    ...
    private void Awake()
    {
        SurvivalplayerMovement = GetComponent<SurvivalPlayerMovement>();
    ...
    private void Die()
    {
        ...
        // PlayerGun activeGun = GetComponentInChildren<SurvivalPlayerGun>();
        // if (activeGun != null)
        // {
        ...
        if (SurvivalplayerMovement != null) SurvivalplayerMovement.enabled = false;
